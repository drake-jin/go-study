...
func main(){
    fmt.Println("57.Reading_Files.go---------Start------------\n\n")
    ...
    // that may be useful both for its efficiency with many small reads and 
