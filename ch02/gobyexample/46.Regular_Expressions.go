/*
Title: 46.Regular_Expressions.go
Author: OpenSource
Date: 2017-05-23
...
func main(){
    fmt.Println("46.Regular_Expressions.go---------Start------------\n\n")
    ...
    fmt.Println(r.ReplaceAllString("a peach", "<fruits>")) // a <fruits>
