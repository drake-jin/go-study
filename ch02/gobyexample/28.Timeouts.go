...
func main(){
    ...
    // res := <-c1 awaits the result and <-Time.After awaits a value to be sent after 
    // the timeout of 1s. 
    ...
    // This is a good idea in general because other important 
    // Go features are based on channels and select. 
